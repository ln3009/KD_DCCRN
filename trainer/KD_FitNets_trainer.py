...
class FitNets_Trainer(BaseTrainer):
    ...
    def __init__(self, config, teacher_model, model, train_iter, valid_iter, device="cpu"):
        ...
        # reconfig path
        self.checkpoints_path = os.path.join(self.base_path, "checkpoints", "fitnets_x1_16_0.95")
        self.logs_path = os.path.join(self.base_path, "logs", "train", "fitnets_x1_16_0.95")
        # mkdir path
