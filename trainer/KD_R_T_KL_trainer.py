...
class KD_R_T_KL_Trainer(BaseTrainer):
    ...
    def __init__(self, config, teacher_model, model, train_iter, valid_iter, device="cpu"):
        ...
        # reconfig path
        self.checkpoints_path = os.path.join(self.base_path, "checkpoints", "KD_R_T15_KL_x1_16")
        self.logs_path = os.path.join(self.base_path, "logs", "train", "KD_R_T15_KL_x1_16")
        # mkdir path
...
if __name__ == "__main__":
    '''
    python trainer/KD_R_T_KL_trainer.py   -TC config/base_config.toml   -SC config/KD_R_T_config.toml  --gpu 0
    '''
