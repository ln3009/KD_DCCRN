...
class FitNets_Trainer(BaseTrainer):
    ...
    def __init__(self, config, teacher_model, model, train_iter, valid_iter, device="cpu"):
        ...
        # reconfig path
        self.checkpoints_path = os.path.join(self.base_path, "checkpoints", "fitnets_x1_16_0.6")
        self.logs_path = os.path.join(self.base_path, "logs", "train", "fitnets_x1_16_0.6")
        # mkdir path
...
if __name__ == "__main__":
    '''
    python trainer/KD_FitNets_trainer1.py   -TC config/base_config.toml   -SC config/KD_FitNets_config.toml  --gpu 1
